...
超文本传输​​协议（HTTP）获得了巨大的成功。然而，HTTP/1.1所采用的底层传输方式（[[RFC7230]，Section 6](https://tools.ietf.org/html/rfc7230#section-6)）中的几个特性给今天的应用程序带来了整体的负面效果。
...
ref：[evagle/http2-cn](https://github.com/evagle/http2-cn)，感觉他翻译的更好一点，很多都是参考他的翻译。
